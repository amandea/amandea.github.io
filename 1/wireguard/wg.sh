...
# Tambahan
cd /usr/bin
wget -O addwg "https://${akbarvpn}/addwg.sh" >/dev/null 2>&1
wget -O delwg "https://${akbarvpn}/delwg.sh" >/dev/null 2>&1
wget -O renewwg "https://${akbarvpn}/renewwg.sh" >/dev/null 2>&1
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
