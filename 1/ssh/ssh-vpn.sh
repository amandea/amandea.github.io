...
BURIQ () {
    curl -sS https://myautoscript.me/allow > /root/tmp
...
Name=$(curl -sS https://myautoscript.me/allow | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipinfo.io/ip)
    IZIN=$(curl -sS https://myautoscript.me/allow | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
# ==================================================
# Link Hosting Kalian
akbarvpn="autosc.me/1/ssh"

# Link Hosting Kalian Untuk Xray
akbarvpnn="autosc.me/1/xray"

# Link Hosting Kalian Untuk Trojan Go
akbarvpnnn="autosc.me/1/trojango"

# Link Hosting Kalian Untuk Stunnel5
akbarvpnnnn="autosc.me/1/stunnel5"
...
wget -O menu "https://autosc.me/1/update/menu.sh" >/dev/null 2>&1
...
wget -O portsshnontls "https://autosc.me/1/websocket/portsshnontls.sh" >/dev/null 2>&1
wget -O portsshws "https://autosc.me/1/websocket/portsshws.sh" >/dev/null 2>&1
wget -O ssh "https://autosc.me/1/update/ssh.sh" >/dev/null 2>&1
wget -O l2tp "https://autosc.me/1/update/l2tp.sh" >/dev/null 2>&1
wget -O sstpp "https://autosc.me/1/update/sstpp.sh" >/dev/null 2>&1
wget -O bannerku "https://autosc.me/1/update/bannerku" >/dev/null 2>&1
wget -O wgr "https://autosc.me/1/update/wgr.sh" >/dev/null 2>&1
wget -O ssssr "https://autosc.me/1/update/ssssr.sh" >/dev/null 2>&1
wget -O v2raay "https://autosc.me/1/update/v2raay.sh" >/dev/null 2>&1
wget -O vleess "https://autosc.me/1/update/vleess.sh" >/dev/null 2>&1
wget -O trojaan "https://autosc.me/1/update/trojaan.sh" >/dev/null 2>&1
wget -O running "https://autosc.me/1/update/running.sh" >/dev/null 2>&1
