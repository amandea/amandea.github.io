...
wget -O /usr/bin/addl2tp https://${akbarvpn}/addl2tp.sh >/dev/null 2>&1 && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${akbarvpn}/dell2tp.sh >/dev/null 2>&1 && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${akbarvpn}/addpptp.sh >/dev/null 2>&1 && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${akbarvpn}/delpptp.sh >/dev/null 2>&1 && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${akbarvpn}/renewpptp.sh >/dev/null 2>&1 && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${akbarvpn}/renewl2tp.sh >/dev/null 2>&1 && chmod +x /usr/bin/renewl2tp
