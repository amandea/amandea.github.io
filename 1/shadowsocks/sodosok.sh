...
# Link Hosting Kalian
akbarvpn="autosc.me/1/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${akbarvpn}/addss.sh" >/dev/null 2>&1
wget -O delss "https://${akbarvpn}/delss.sh" >/dev/null 2>&1
wget -O cekss "https://${akbarvpn}/cekss.sh" >/dev/null 2>&1
wget -O renewss "https://${akbarvpn}/renewss.sh" >/dev/null 2>&1
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
