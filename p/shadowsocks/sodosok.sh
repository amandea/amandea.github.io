...
# Link Hosting Kalian
akbarvpn="autosc.me/shadowsocks"
...
echo "#############################################"
echo "Install Paket..."
apt-get install --no-install-recommends build-essential autoconf >/dev/null 2>&1 libtool libssl-dev libpcre3-dev libev-dev asciidoc xmlto automake -y >/dev/null 2>&1
