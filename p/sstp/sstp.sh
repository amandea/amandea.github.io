...
mkdir /home/sstp
touch /home/sstp/sstp_account >/dev/null 2>&1
touch /var/lib/fsidvpn/data-user-sstp >/dev/null 2>&1
...
#install sstp
apt-get install -y build-essential cmake gcc linux-headers-`uname -r` git libpcre3-dev libssl-dev liblua5.1-0-dev ppp >/dev/null 2>&1
...
wget -O /etc/accel-ppp.conf "https://${akbarvpn}/accel.conf" >/dev/null 2>&1
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${akbarvpn}/addsstp.sh >/dev/null 2>&1 && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${akbarvpn}/delsstp.sh >/dev/null 2>&1 && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${akbarvpn}/ceksstp.sh >/dev/null 2>&1 && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${akbarvpn}/renewsstp.sh >/dev/null 2>&1 && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
