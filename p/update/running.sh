...
sst_status=$(systemctl status shadowsocks-libev | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1) 
...
echo -e "❇️ Shadowsocks-R           :$status_sst"
...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo ""
echo -e "[ ${green}press any key to back on menu${NC} ]"
read
menu
