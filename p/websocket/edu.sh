...
wget -q -O /usr/local/bin/ws-nontls https://${akbarvpn}/websocket.py >/dev/null 2>&1
...
Documentation=https://t.me/FERIDEV
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://${akbarvpn}/ws-ovpn.py >/dev/null 2>&1
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://${akbarvpn}/ws-tls >/dev/null 2>&1
