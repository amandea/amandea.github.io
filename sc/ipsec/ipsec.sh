...
wget -q -O /usr/bin/add-l2tp "https://autosc.me/sc/ipsec/add-l2tp.sh" && chmod +x /usr/bin/add-l2tp
wget -q -O /usr/bin/del-l2tp "https://autosc.me/sc/ipsec/del-l2tp.sh" && chmod +x /usr/bin/del-l2tp
wget -q -O /usr/bin/add-pptp "https://autosc.me/sc/ipsec/add-pptp.sh" && chmod +x /usr/bin/add-pptp
wget -q -O /usr/bin/del-pptp "https://autosc.me/sc/ipsec/del-pptp.sh" && chmod +x /usr/bin/del-pptp
wget -q -O /usr/bin/renew-pptp "https://autosc.me/sc/ipsec/renew-pptp.sh" && chmod +x /usr/bin/renew-pptp
wget -q -O /usr/bin/renew-l2tp "https://autosc.me/sc/ipsec/renew-l2tp.sh" && chmod +x /usr/bin/renew-l2tp
wget -q -O /usr/bin/trial-pptp "https://autosc.me/sc/ipsec/trial-pptp.sh" && chmod +x /usr/bin/trial-pptp
wget -q -O /usr/bin/trial-l2tp "https://autosc.me/sc/ipsec/trial-l2tp.sh" && chmod +x /usr/bin/trial-l2tp

touch /var/lib/scrz-prem/data-user-l2tp > /dev/null 2>&1
touch /var/lib/scrz-prem/data-user-pptp > /dev/null 2>&1

wget -q -O /usr/bin/ipsec-menu "https://autosc.me/sc/menu_all/ipsec-menu.sh" && chmod +x /usr/bin/ipsec-menu
