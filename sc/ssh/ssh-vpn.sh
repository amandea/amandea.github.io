...
curl -sS https://autosc.me/sc/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
# install squid
cd
curl -sS "https://autosc.me/sc/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/squid/squid.conf
...
wget -q https://autosc.me/sc/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://autosc.me/ssh/issue.net"
...
wget -q -O /usr/bin/ohp "https://autosc.me/sc/dll/ohp" && chmod +x /usr/bin/ohp
wget -q -O /usr/bin/ohp-ssh "https://autosc.me/sc/dll/ohp-ssh.sh" && chmod +x /usr/bin/ohp-ssh
wget -q -O /usr/bin/ohp-db "https://autosc.me/sc/dll/ohp-db.sh" && chmod +x /usr/bin/ohp-db
wget -q -O /usr/bin/ohp-opn "https://autosc.me/sc/dll/ohp-opn.sh" && chmod +x /usr/bin/ohp-opn
