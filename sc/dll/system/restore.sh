...
cekdata=$(curl -sS https://autosc.me/bakup/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
...
wget -q -O /root/backup/backup.zip "https://autosc.me/bakup/$NameUser/$NameUser.zip" &> /dev/null
