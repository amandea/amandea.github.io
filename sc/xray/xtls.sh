...
wget -q -O /usr/bin/addxtls "https://autosc.me/sc/xray/add.sh" && chmod +x /usr/bin/addxtls
wget -q -O /usr/bin/delxtls "https://autosc.me/sc/xray/del.sh" && chmod +x /usr/bin/delxtls
wget -q -O /usr/bin/cekxtls "https://autosc.me/sc/xray/chk.sh" && chmod +x /usr/bin/cekxtls
wget -q -O /usr/bin/renewxtls "https://autosc.me/sc/xray/rnw.sh" && chmod +x /usr/bin/renewxtls
wget -q -O /usr/bin/portxtls "https://autosc.me/sc/xray/pxt.sh" && chmod +x /usr/bin/portxtls
