...
wget -q -O /usr/bin/add-ssr https://autosc.me/sc/shadowsocks/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -q -O /usr/bin/del-ssr https://autosc.me/sc/shadowsocks/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -q -O /usr/bin/renew-ssr https://autosc.me/sc/shadowsocks/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
wget -q -O /usr/bin/trial-ssr https://autosc.me/sc/shadowsocks/trial-ssr.sh && chmod +x /usr/bin/trial-ssr
